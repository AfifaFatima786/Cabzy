  ...
  return (
    <div>
        <h5 onClick={()=>{
            ...
            <div onClick={()=>{props.setConfirmRidePanel(true)}} className='flex border-2 p-2 border-gray-200 active:border-black rounded-xl w-full items-center gap-2   justify-between '>
            ...
            <div onClick={()=>{props.setConfirmRidePanel(true)}} className='flex border-2 p-2 border-gray-300 active:border-black rounded-xl w-full items-center gap-2   justify-between '>
